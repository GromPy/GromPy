 ...
 *
 * $Id: nb_kernel101_ia32_3dnow.h,v 1.1 2004/12/26 19:27:08 lindahl Exp $
 * 
 ...
 */
#ifndef _NB_KERNEL101_IA32_3DNOW_H_
#define _NB_KERNEL101_IA32_3DNOW_H_

/*! \file  nb_kernel101_ia32_3dnow.h
 *  \brief ia32 3DNow-optimized versions of nonbonded kernel 101
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 101 with forces, optimized for ia32 3DNow.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel101_ia32_3dnow  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 101 without forces, optimized for ia32 3DNow.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Standard 1/r <br>
 ...
 */
void
nb_kernel101nf_ia32_3dnow(int *   nri,        int     iinr[],   int     jindex[],
                          int     jjnr[],     int     shift[],  float   shiftvec[],
                          float   fshift[],   int     gid[],    float   pos[],
                          float   faction[],  float   charge[], float * facel,
                          float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL101_IA32_3DNOW_H_ */
