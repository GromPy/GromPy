 ...
 *
 * $Id: nb_kernel201_x86_64_sse.h,v 1.1 2004/12/26 19:33:01 lindahl Exp $
 * 
 ...
 */
#ifndef _NB_KERNEL201_X86_64_SSE_H_
#define _NB_KERNEL201_X86_64_SSE_H_


/*! \file  nb_kernel201_x86_64_sse.h
 *  \brief x86_64 SSE-optimized versions of nonbonded kernel 201
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 201 with forces, optimized for x86_64 sse.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel201_x86_64_sse  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 201 without forces, optimized for x86_64 sse.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Reaction-field <br>
 ...
 */
void
nb_kernel201nf_x86_64_sse(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL201_X86_64_SSE_H_ */
