 ...
 *
 * $Id: nb_kernel410_x86_64_sse.h,v 1.1 2004/12/26 19:33:01 lindahl Exp $
 * 
 ...
 */
#ifndef _NB_KERNEL410_X86_64_SSE_H_
#define _NB_KERNEL410_X86_64_SSE_H_

/*! \file  nb_kernel410_x86_64_sse.h
 *  \brief x86_64 SSE-optimized versions of nonbonded kernel 410
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 410 with forces, optimized for x86_64 sse.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel410_x86_64_sse  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 410 without forces, optimized for x86_64 sse.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Generalized-Born <br>
 ...
 */
void
nb_kernel410nf_x86_64_sse(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL410_X86_64_SSE_H_ */
