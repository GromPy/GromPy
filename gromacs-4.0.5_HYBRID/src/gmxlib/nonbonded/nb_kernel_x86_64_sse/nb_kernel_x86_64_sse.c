 ...
 *
 * $Id: nb_kernel_x86_64_sse.c,v 1.1 2004/12/26 19:33:01 lindahl Exp $
 * 
...
#include "nb_kernel_x86_64_sse.h"

/* Include x86_64 SSE kernel headers in local directory */
#include "nb_kernel010_x86_64_sse.h"
#include "nb_kernel030_x86_64_sse.h"
#include "nb_kernel100_x86_64_sse.h"
#include "nb_kernel101_x86_64_sse.h"
#include "nb_kernel102_x86_64_sse.h"
#include "nb_kernel103_x86_64_sse.h"
#include "nb_kernel104_x86_64_sse.h"
#include "nb_kernel110_x86_64_sse.h"
#include "nb_kernel111_x86_64_sse.h"
#include "nb_kernel112_x86_64_sse.h"
#include "nb_kernel113_x86_64_sse.h"
#include "nb_kernel114_x86_64_sse.h"
#include "nb_kernel130_x86_64_sse.h"
#include "nb_kernel131_x86_64_sse.h"
#include "nb_kernel132_x86_64_sse.h"
#include "nb_kernel133_x86_64_sse.h"
#include "nb_kernel134_x86_64_sse.h"
#include "nb_kernel200_x86_64_sse.h"
#include "nb_kernel201_x86_64_sse.h"
#include "nb_kernel202_x86_64_sse.h"
#include "nb_kernel203_x86_64_sse.h"
#include "nb_kernel204_x86_64_sse.h"
#include "nb_kernel210_x86_64_sse.h"
#include "nb_kernel211_x86_64_sse.h"
#include "nb_kernel212_x86_64_sse.h"
#include "nb_kernel213_x86_64_sse.h"
#include "nb_kernel214_x86_64_sse.h"
#include "nb_kernel230_x86_64_sse.h"
#include "nb_kernel231_x86_64_sse.h"
#include "nb_kernel232_x86_64_sse.h"
#include "nb_kernel233_x86_64_sse.h"
#include "nb_kernel234_x86_64_sse.h"
#include "nb_kernel300_x86_64_sse.h"
#include "nb_kernel301_x86_64_sse.h"
#include "nb_kernel302_x86_64_sse.h"
#include "nb_kernel303_x86_64_sse.h"
#include "nb_kernel304_x86_64_sse.h"
#include "nb_kernel310_x86_64_sse.h"
#include "nb_kernel311_x86_64_sse.h"
#include "nb_kernel312_x86_64_sse.h"
#include "nb_kernel313_x86_64_sse.h"
#include "nb_kernel314_x86_64_sse.h"
#include "nb_kernel330_x86_64_sse.h"
#include "nb_kernel331_x86_64_sse.h"
#include "nb_kernel332_x86_64_sse.h"
#include "nb_kernel333_x86_64_sse.h"
#include "nb_kernel334_x86_64_sse.h"
...
#include "nb_kernel_x86_64_sse.h"
#include "nb_kernel_x86_64_sse_test_asm.h"


static nb_kernel_t *
kernellist_x86_64_sse[eNR_NBKERNEL_NR] = 
{
...
static void 
nb_kernel_x86_64_sse_sigill_handler(int n)
{
  nb_kernel_x86_64_sse_present=FALSE;
  longjmp(nb_kernel_x86_64_sse_testprog,n);
}
 ...
 */
int 
nb_kernel_x86_64_sse_test(FILE *                log)
{
	/* 
	 ...
	 */
	setjmp(nb_kernel_x86_64_sse_testprog); 

	if(nb_kernel_x86_64_sse_present)
...
nb_kernel_setup_x86_64_sse(FILE *log,nb_kernel_t **list)
{
    ...
    if(nb_kernel_x86_64_sse_test(log) != 0)
        return;
    
    for(i=0;i<eNR_NBKERNEL_NR;i++)
    {
        p = kernellist_x86_64_sse[i];
        if(p!=NULL)
            list[i] = p; 
    }
}    
