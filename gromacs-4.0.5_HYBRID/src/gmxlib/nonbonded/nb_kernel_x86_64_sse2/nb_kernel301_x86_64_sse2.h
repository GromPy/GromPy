 ...
 *
 * $Id: nb_kernel301_x86_64_sse2.h,v 1.1 2004/12/26 19:34:34 lindahl Exp $
 * 
 ...
 */
#ifndef _NB_KERNEL301_X86_64_SSE2_H_
#define _NB_KERNEL301_X86_64_SSE2_H_


/*! \file  nb_kernel301_x86_64_sse2.h
 *  \brief x86-64 SSE2-optimized versions of nonbonded kernel 301
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 301 with forces, optimized for x86-64 sse2.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel301_x86_64_sse2(int *    nri,        int      iinr[],    int      jindex[],
...
/*! \brief Nonbonded kernel 301 without forces, optimized for x86-64 sse2.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Tabulated <br>
 ...
 */
void
nb_kernel301nf_x86_64_sse2(int *    nri,        int      iinr[],    int      jindex[],
                           int      jjnr[],     int      shift[],   double   shiftvec[],
                           double   fshift[],   int      gid[],     double   pos[],
                           double   faction[],  double   charge[],  double * facel,
                           double * krf,        double * crf,       double   Vc[],
...
#endif /* _NB_KERNEL301_X86_64_SSE2_H_ */
