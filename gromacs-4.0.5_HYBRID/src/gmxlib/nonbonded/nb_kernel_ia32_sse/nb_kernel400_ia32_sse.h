 ...
 *
 * $Id: nb_kernel400_ia32_sse.h,v 1.1 2004/12/26 19:28:54 lindahl Exp $
 * 
 ...
 */
#ifndef _NB_KERNEL400_IA32_SSE_H_
#define _NB_KERNEL400_IA32_SSE_H_

/*! \file  nb_kernel400_ia32_sse.h
 *  \brief ia32 SSE-optimized versions of nonbonded kernel 400
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 400 with forces, optimized for ia32 sse.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel400_ia32_sse  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 400 without forces, optimized for ia32 sse.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Generalized-Born <br>
 ...
 */
void
nb_kernel400nf_ia32_sse(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL400_IA32_SSE_H_ */
