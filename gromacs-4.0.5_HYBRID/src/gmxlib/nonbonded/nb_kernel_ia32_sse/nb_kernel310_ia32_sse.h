 ...
 *
 * $Id: nb_kernel310_ia32_sse.h,v 1.1 2004/12/26 19:28:54 lindahl Exp $
 * 
 ...
 */
#ifndef _NB_KERNEL310_IA32_SSE_H_
#define _NB_KERNEL310_IA32_SSE_H_

/*! \file  nb_kernel310_ia32_sse.h
 *  \brief ia32 SSE-optimized versions of nonbonded kernel 310
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 310 with forces, optimized for ia32 sse.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel310_ia32_sse  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 310 without forces, optimized for ia32 sse.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Tabulated <br>
 ...
 */
void
nb_kernel310nf_ia32_sse(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL310_IA32_SSE_H_ */
