 ...
 *
 * $Id: nb_kernel113_ia32_sse.h,v 1.1 2004/12/26 19:28:53 lindahl Exp $
 * 
 ...
 */
#ifndef _NB_KERNEL113_IA32_SSE_H_
#define _NB_KERNEL113_IA32_SSE_H_

/*! \file  nb_kernel113_ia32_sse.h
 *  \brief ia32 SSE-optimized versions of nonbonded kernel 113
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 113 with forces, optimized for ia32 sse.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel113_ia32_sse  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 113 without forces, optimized for ia32 sse.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Standard 1/r <br>
 ...
 */
void
nb_kernel113nf_ia32_sse(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL113_IA32_SSE_H_ */
