 ...
 *
 * $Id: nb_kernel100_ia32_sse2.h,v 1.1 2004/12/26 19:31:00 lindahl Exp $
 * 
 ...
 */
#ifndef _NB_KERNEL100_IA32_SSE2_H_
#define _NB_KERNEL100_IA32_SSE2_H_

/*! \file  nb_kernel100_ia32_sse2.h
 *  \brief ia32 SSE2-optimized versions of nonbonded kernel 100
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 100 with forces, optimized for ia32 sse2.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel100_ia32_sse2  (int *    nri,        int      iinr[],    int      jindex[],
...
/*! \brief Nonbonded kernel 100 without forces, optimized for ia32 sse2.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Standard 1/r <br>
 ...
 */
void
nb_kernel100nf_ia32_sse2(int *    nri,        int      iinr[],    int      jindex[],
                         int      jjnr[],     int      shift[],   double   shiftvec[],
                         double   fshift[],   int      gid[],     double   pos[],
                         double   faction[],  double   charge[],  double * facel,
                         double * krf,        double * crf,       double   Vc[],
...
#endif /* _NB_KERNEL100_IA32_SSE2_H_ */
