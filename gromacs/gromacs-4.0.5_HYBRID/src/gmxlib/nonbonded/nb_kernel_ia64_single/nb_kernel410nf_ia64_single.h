 ...
 *
 * $Id: nb_kernel410nf_ia64_single.h,v 1.1 2004/12/26 19:48:17 lindahl Exp $
 * 
 ...
 */
#ifndef _NB_KERNEL410NF_IA64S_H_
#define _NB_KERNEL410NF_IA64S_H_

/*! \file  nb_kernel410nf_ia64_single.h
 *  \brief ia64(single)-optimized versions of nonbonded kernel 410
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 410 without forces, optimized for ia64 single precision assembly.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel410nf_ia64_single  (int *   nri,        int     iinr[],   int     jindex[],
...
#endif /* _NB_KERNEL410NF_IA64S_H_ */
